...
const BreedEdit = ({ getBreedById, onUpdate }) => {
  const { id } = useParams();
    ...
    return (
      <div className="max-w-2xl mx-auto text-center py-12">
        ...
        <p className="text-slate-400 mb-6">
          The breed you're trying to edit doesn't exist or may have been
          deleted.
        </p>
        <Link
          to="/"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ submit: "Failed to update breed. Please try again." });
    } finally {
      setIsSubmitting(false);
    }
  };
    ...
    <div className="max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-slate-400">
          Update the information for this dog breed.
        </p>
      </div>
      ...
      >
        ...
        <div className="flex gap-4 pt-4 border-t border-slate-600">
          ...
          >
            {isSubmitting ? "Updating..." : "Update Breed"}
          </button>
          <button
            type="button"
            onClick={handleReset}
